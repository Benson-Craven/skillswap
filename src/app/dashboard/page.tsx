      ...
      <div className="min-h-screen">
          ...
          <div className="brand-container">
            <div className="flex h-20 justify-between">
              <div className="flex items-center">
                <h1 className="text-2xl font-black text-[var(--brand-ink)]">SkillSwap</h1>
              </div>
              <div className="flex items-center gap-4">
                <span className="hidden text-sm font-bold text-[var(--brand-muted)] sm:inline">
        ...
        <main className="brand-container py-8 sm:py-12">
          <div className="mb-8">
            ...
            <h2 className="mt-3 max-w-3xl text-4xl font-black leading-tight text-[var(--brand-ink)] sm:text-5xl">
            ...
            {!isProfileComplete ? (
              <div className="brand-card mb-8 p-6 sm:p-8">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                  <div className="flex-shrink-0">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--brand-yellow)] text-[var(--brand-ink)]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-2 max-w-2xl text-base font-medium leading-7 text-[var(--brand-muted)]">
              ...
              <div className="brand-card mb-8 p-6 sm:p-8">
                ...
                <p className="mt-2 text-base font-medium leading-7 text-[var(--brand-muted)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="brand-card-flat p-6">
                <CheckCircle2 className="mb-5 h-7 w-7 text-[var(--brand-blue)]" />
                <h3 className="text-sm font-black uppercase text-[var(--brand-muted)]">Profile Status</h3>
                <p className="mt-2 text-2xl font-black text-[var(--brand-ink)]">
                  {isProfileComplete ? 'Complete' : 'In progress'}
                </p>
              </div>
              
              <div className="brand-card-flat p-6">
                <BookOpen className="mb-5 h-7 w-7 text-[var(--brand-blue)]" />
                <h3 className="text-sm font-black uppercase text-[var(--brand-muted)]">Skills Offered</h3>
                <p className="mt-2 text-2xl font-black text-[var(--brand-ink)]">
              ...
              <div className="brand-card-flat p-6">
                <Users className="mb-5 h-7 w-7 text-[var(--brand-blue)]" />
                <h3 className="text-sm font-black uppercase text-[var(--brand-muted)]">Connections</h3>
                <p className="mt-2 text-2xl font-black text-[var(--brand-ink)]">
                  Coming soon
                </p>
              </div>
